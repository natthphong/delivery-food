            ...
            <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-3 text-sm text-slate-700">
                    <div className="relative" ref={menuRef}>
                        ...
                        {open && (
                            <div className="absolute right-0 z-20 mt-2 w-60 rounded-2xl border border-slate-200 bg-white p-2 shadow-lg">
                                <button
                                    type="button"
                                    onClick={handleTopUp}
                                    className={`${MENU_TRANSITION_CLASSES} flex w-full items-center justify-between rounded-xl px-3 py-2 text-left text-sm font-medium text-emerald-700`}
                                >
                                    <span>{t(I18N_KEYS.NAV_ACCOUNT_TOP_UP)}</span>
                                    <span className="text-xs text-emerald-500">QR</span>
                                </button>
                                <button
                                    type="button"
